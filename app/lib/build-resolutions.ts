...
export function resolutionMatchesCheck(
  ...
  check: Pick<PreflightCheck, "id" | "code" | "policy" | "sourceSha256">,
) {
  ...
  if (sourceWideOcrMatch && (!resolution.sourceSha256 || resolution.sourceSha256 !== check.sourceSha256)) return false;
