...
export function writableMatterFindings(review: TemplateMatterReview): TemplateMatterFinding[] {
  return [...review.matterNumbers, ...review.partyNames, ...review.forums, ...review.matterTitles];
}
