...
if (home.button !== "Open the guided sample folder" || home.remoteLinks !== 0) throw new Error(`Unexpected home state: ${JSON.stringify(home)}`);
await screenshot("01-home.png", false);

await evaluate(`window.dispatchEvent(new Event("exhibit-builder:analyse-guided-sample"))`);
