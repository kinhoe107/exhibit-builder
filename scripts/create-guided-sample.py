...
STATEMENT_DIR = OUT / "Witness statement"
EXHIBITS_DIR = OUT / "Exhibits"
...
def create_statement():
    ...
    document.save(STATEMENT_DIR / "01_GUIDED_SAMPLE_Witness_Statement.docx")
...
def create_pdf(file_name, title, date_label, date_value, reference, explanation):
    ...
    doc = SimpleDocTemplate(str((OUT if file_name.startswith("06_") else EXHIBITS_DIR) / file_name), pagesize=A4, rightMargin=22 * mm, leftMargin=22 * mm, topMargin=20 * mm, bottomMargin=20 * mm, title=title, author="Exhibit Builder", subject="Guided sample exhibit")
...
def create_project_report():
    ...
    document.core_properties.author = ""
    document.core_properties.last_modified_by = ""
    document.save(EXHIBITS_DIR / "03_SAMPLE_Project_Report.docx")
...
def create_sample_email():
    ...
    (EXHIBITS_DIR / "04_SAMPLE_Claimant_Email.eml").write_text(content, encoding="utf-8", newline="")
...
if __name__ == "__main__":
    ...
    # Witness statement pictures are rebuilt by scripts/rebuild-guided-statement.mjs.
