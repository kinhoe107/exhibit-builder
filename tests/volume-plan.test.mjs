...
test("creates separate AH1 volume PDFs and keeps index numbers continuous", async () => {
  ...
  assert.deepEqual(separateLabels[0], ["1", "2", "LV-1"]);
  assert.deepEqual(separateLabels[1], ["3", "4", "LV-2"], "preliminary and exhibit numbering both continue across volume PDFs");
});
