...
test("build reports real local assembly stages in order", async () => {
  ...
  const analysis = { caseTitle: "Local matter", statementName: "Statement.docx", statementHash: "b".repeat(64), evidence: [evidence], candidates: [candidate], unreferenced: [], generatedAt: new Date().toISOString() };
  const stages = [];
