...
contextBridge.exposeInMainWorld("bundleBuilderDesktop", {
  ...
  openGuidedSampleFolder() {
    return ipcRenderer.invoke("bundle-builder:open-guided-sample-folder");
  },
  recoveryStatus() {
